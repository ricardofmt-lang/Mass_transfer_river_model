...
# This ensures the app runs immediately without file upload.
...
ChannelLength:,12000,m,,,Courant Number,,1.25
NumberOfCells:,300,-,,,Diffusion Number,,0.13
RiverWidth:,100,m,"Flow and Velocity are computed...",,Grid Reynolds Number,,10
WaterDepth:,0.5,m,,,,,
RiverSlope:,0.0001,m/m,,,,,
ManningCoef(n):,0.025,m(-1/3)s,,,Residence Time,,0.6
